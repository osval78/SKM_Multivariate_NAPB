...
write.csv(GY_Summaries$env,file="Summary_Chis_GLS_Lasso_Multitrait_GY.csv")
...
write.csv(Height_Summaries$env,file="Summary_Chis_GLS_Lasso_Multitrait_Height.csv")
