...
write.csv(GY_Summaries$env,file="Summary_Chis_GLM_Grid_Multitrait_GY.csv")
...
write.csv(Height_Summaries$env,file="Summary_Chis_GLM_Grid_Multitrait_Height.csv")
