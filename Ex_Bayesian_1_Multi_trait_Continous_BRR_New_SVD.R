...
ETA <- list(
  ...
  list(x =X_ge, model = "BRR") ####Effects of genotypexEnvironment
)
...
#DTHDSummaries$fold
Summary_Env_GY
write.csv(Summary_Env_GY,file="Summary_Chis_BRR_Multitrait_GY.csv")
...
#DTHDSummaries$fold
Summary_Env_Height
write.csv(Summary_Env_Height,file="Summary_Chis_BRR_Multitrait_Height.csv")
