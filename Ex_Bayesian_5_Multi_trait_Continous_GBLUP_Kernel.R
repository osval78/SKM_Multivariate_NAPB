...
K_g=Z_g%*%GK1%*%t(Z_g) ###Linear kernel
...
write.csv(GY_Summaries$env,file="Summary_Chis_GBLUP_Gaussian_Kernel_Multitrait_GY.csv")
...
write.csv(Height_Summaries$env,file="Summary_Chis_GBLUP_Gaussian_Kernel_Multitrait_Height.csv")
